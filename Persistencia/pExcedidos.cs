    ...
    public class pExcedidos : CapaDatos
    {
        ...
        public DataSet PagoDeExcedidosPorPresupuesto(string presupuesto)
        {
            try
            {
                ...
                MySqlDataAdapter MySqlAdapter = new MySqlDataAdapter();
                string sql = "SELECT DISTINCT s.socio_apellido, s.socio_nombre, s.socio_nroCobro, s.socio_nro, e.presupuestodelpago, e.aretener, e.retenido, (e.aretener - e.retenido) as deuda, (e.importepagado + e.retenido) - e.aretener as mora, (((e.importepagado + e.retenido) - e.aretener) + (e.aretener - e.retenido)) as total, CONCAT(i.inciso_codigo, ' - ', i.inciso_nombre), CONCAT(o.oficina_codigo, ' - ', o.oficina_nombre) FROM coopmef.excedidos e, coopmef.oficina o, coopmef.inciso i, coopmef.socio s where e.socio_id = s.socio_id and s.socio_oficinaId = o.oficina_id and s.socio_incisoId = i.inciso_id and e.presupuestodelpago != '' and e.presupuesto = '" + presupuesto + "' order by s.socio_apellido ASC";
