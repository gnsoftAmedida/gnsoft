...
namespace Persistencia
{
    public class pCobranzaProvisoria : CapaDatos
    {
        ...
        public void modificarCobranzaProvisoria(int parCobranza_id, int parPrestamo_id, String parCedula, double parTasa, double parPorcentajeiva, double parMontopedido, int parCantidadcuotas, int parNrodecuotas, double parImportecuota, double parAmortizacioncuota, double parInteresCuota, double parIvaCuota, double parAmortizacionVencer, double parInteresVencer, double parAporteCapital, String parSocio_id)
        {
            ...
            string sql = "Update cobranzaprovisoria set prestamo_id = '" + parPrestamo_id + "', cedula = '" + parCedula.Replace("-", "").Replace(".", "").Replace(",", "") + "', tasa = '" + parTasa.ToString().Replace(",", ".") + "', porcentajeiva = '" + parPorcentajeiva.ToString().Replace(",", ".") + "', montopedido = '" + parMontopedido.ToString().Replace(",", ".") + "', cantidadcuotas = '" + parCantidadcuotas.ToString().Replace(",", ".") + "', nrodecuotas = '" + parNrodecuotas.ToString().Replace(",", ".") + "', importecuotas = '" + parImportecuota.ToString().Replace(",", ".") + "', AmortizacionCuota = '" + parAmortizacioncuota.ToString().Replace(",", ".") + "', InteresCuota = '" + parInteresCuota.ToString().Replace(",", ".") + "', IvaCuota = '" + parIvaCuota.ToString().Replace(",", ".") + "', AmortizacionVencer = '" + parAmortizacionVencer.ToString().Replace(",", ".") + "', InteresVencer = '" + parInteresVencer.ToString().Replace(",", ".") + "', aportecapital = '" + parAporteCapital.ToString().Replace(",", ".") + "', socio_id = '" + parSocio_id + "' WHERE cobranzaprovisoria_id =" + parCobranza_id;
        ...
        public void GuardarCobranzaProvisoria(int parPrestamo_id, String parCedula, double parTasa, double parPorcentajeiva, double parMontopedido, int parCantidadcuotas, int parNrodecuotas, double parImportecuota, double parAmortizacioncuota, double parInteresCuota, double parIvaCuota, double parAmortizacionVencer, double parInteresVencer, int parSocio_id)
        {
            ...
            string sql;
            sql = "INSERT INTO cobranzaprovisoria (prestamo_id, cedula , tasa , porcentajeiva , montopedido, cantidadcuotas, nrodecuotas, importecuota, AmortizacionCuota, InteresCuota , IvaCuota , AmortizacionVencer , InteresVencer , socio_id ) VALUES ('" + parPrestamo_id + "', '" + parCedula.Replace("-", "").Replace(".", "").Replace(",", "") + "', '" + parTasa.ToString().Replace(",", ".") + "','" + parPorcentajeiva.ToString().Replace(",", ".") + "','" + parMontopedido.ToString().Replace(",", ".") + "', '" + parCantidadcuotas + "', '" + parNrodecuotas + "','" + parImportecuota.ToString().Replace(",", ".") + "','" + parAmortizacioncuota.ToString().Replace(",", ".") + "','" + parInteresCuota.ToString().Replace(",", ".") + "','" + parIvaCuota.ToString().Replace(",", ".") + "', '" + parAmortizacionVencer.ToString().Replace(",", ".") + "', '" + parInteresVencer.ToString().Replace(",", ".") + "','" + parSocio_id + "');" + "Select last_insert_id()";
