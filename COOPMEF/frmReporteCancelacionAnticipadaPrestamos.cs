        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            if (cancelacionesAnticipadas.Tables["canelacionesAnticipadas"].Rows.Count > 0)
            {
                for (int n = 0; n <= cancelacionesAnticipadas.Tables["canelacionesAnticipadas"].Rows.Count - 1; n++)
                {
                    ...
                    cancelaciones.cancelacion.Rows.Add(FechaCancelacion, socio_nro, socio_nombre, socio_apellido, NumeroPrestamo, CuotasPactadas, CuotasPagadas, Tasa, MontoVale, ImporteCuota, AmortizacionVencer, InteresesVencer, presupuesto, fecha);
                }
